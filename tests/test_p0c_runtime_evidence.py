...
def _write_artifacts(root: Path, source_sha: str) -> None:
...
def test_build_bundle_requires_every_independent_artifact(tmp_path: Path) -> None:
    ...
    bundle = build_bundle(tmp_path, "a" * 40)
